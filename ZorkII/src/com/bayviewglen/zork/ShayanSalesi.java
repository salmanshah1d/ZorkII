...
public class ShayanSalesi extends NonPlayableCharacter {
	...
	public void talk(Inventory inv) {
		...
		System.out.println(
				"ShayanSl: Hello, I am Shayan Salesi, CEO of Saturn Capital. Please buy some Saturn Capital shares. (Select the number of the option you wish to say.)");
		while (stillTalking) {
			System.out.println();
			...
			if (response.equals("1") == false && response.equals("2") == false && response.equals("3") == false
				...
				System.out.println(
						"I wasn't able to find any investors anywhere else in the world, so I decided to try my luck here. Would you like to invest?");
			} else if (response.equals("2")) {
				System.out.println(
						"Saturn Capital is a capital investment firm created by myself. You purchase my stocks, and I use that money to increase the companies capital, increasing the price of your stock.");

			} else if (response.equals("3")) {
				System.out.println(
						"Due to unfavorable market conditions and poor investment decisions, I have lost your money. Hahahahah");
	...
	public void displayInventory() {
		...
		if (shayanSlInventory.size() > 0) {
			...
			for (int i = 0; i < shayanSlInventory.size(); i++) {
				System.out.print(
						shayanSlInventory.get(i).getDescription() + ": " + shayanSlInventory.get(i).getCost() + ", ");
			}
		} else {
